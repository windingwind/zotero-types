...
interface AddonManager extends EventTarget {
  ...
  sendAbuseReport(
    ...
    options?: sendAbuseReportOptions,
  ): Promise<any>;
}
...
declare var CSSCustomPropertyRegisteredEvent: {
  ...
  new (
    type: string,
    eventInitDict?: CSSCustomPropertyRegisteredEventInit,
...
interface PlacesEventCounts {
  forEach(
    callbackfn: (value: number, key: string, parent: PlacesEventCounts) => void,
    thisArg?: any,
  ): void;
}
...
declare namespace ChromeUtils {
  ...
  function defineESModuleGetters(
    aTarget: any,
    aModules: any,
...
declare namespace InspectorUtils {
  ...
  function getCSSRegisteredProperty(
    document: Document,
    name: string,
  ...
  function getStyleSheetRuleCountAndAtRules(
    sheet: CSSStyleSheet,
...
declare function getDefaultComputedStyle(
  elt: Element,
  pseudoElt?: string,
): CSSStyleDeclaration | null;
declare function getGroupMessageManager(
  aGroup: string,
...
declare function promiseDocumentFlushed(
  callback: PromiseDocumentFlushedCallback,
): Promise<any>;
...
declare function setScrollMarks(
  marks: number[],
...
declare function sizeToContentConstrained(
  constraints?: SizeToContentConstraints,
): void;
...
interface L10nFileSource {
  createMock(
    ...
    locales: Iterable<string>,
    prePath: string,
    fs: Iterable<L10nFileSourceMockFile>,
  ): L10nFileSource;
}

interface L10nRegistry {
  generateBundles(
    aLocales: Iterable<string>,
    aResourceIds: Iterable<L10nResourceId>,
  ): FluentBundleAsyncIterator;
  generateBundlesSync(
    aLocales: Iterable<string>,
    aResourceIds: Iterable<L10nResourceId>,
...
interface Localization {
  ...
  formatMessages(
    aKeys: Iterable<L10nKey>,
  ): Promise<Iterable<L10nMessage | null>>;
...
interface TestInterfaceMaplikeObject
  extends ReadonlyMap<string, TestInterfaceMaplike> {}
...
interface TestInterfaceAsyncIterableSingleWithArgs {
  [Symbol.asyncIterator](
    options?: TestInterfaceAsyncIteratorOptions,
