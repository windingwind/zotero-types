...
declare namespace _ZoteroTypes {
    ...
    interface Annotations {
        ...
        readonly PROPS: ['type', 'authorName', 'text', 'comment', 'color', 'pageLabel', 'sortIndex', 'position'];

        getCacheImagePath(annotation: object & { libraryID: number, key: string }): string;
        hasCacheImage(item: object & { libraryID: number, key: string }): Promise<boolean>;
        saveCacheImage(annotation: object & { libraryID: number, key: string }, blob: Blob): Promise<string>;
        removeCacheImage(annotation: object & { libraryID: number, key: string }): Promise<void>;
         ...
         */
        splitAnnotationJSON(annotation: Zotero.Item | Annotations.AnnotationJson): Annotations.AnnotationJson[];
