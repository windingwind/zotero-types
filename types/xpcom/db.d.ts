type QueryParams = string | number | object | null | (string | number | object | undefined)[];
...
declare namespace _ZoteroTypes {
  interface DB {
	...
	parseQueryAndParams(sql: string, params: QueryParams): [string, QueryParams];
	...
	**/
	 ...
	 */
	queryAsync(sql: string, params: QueryParams, options?: {inBackup: boolean, noParseParams: boolean, onRow: (row: unknown, cancel: unknown) => void, noCache: boolean}): Promise<Object[] | void>;


	queryTx(sql: string, params: QueryParams, options?: {inBackup: boolean, noParseParams: boolean, onRow: (row: unknown, cancel: unknown) => void, noCache: boolean}): Promise<Object[] | void>;
	 ...
	 */
	valueQueryAsync(sql: string, params: QueryParams, options?: {inBackup: boolean, noCache: boolean}): Promise<Object[] | boolean>;
	 ...
	 */
	rowQueryAsync(sql: string, params: QueryParams): Promise<Object | boolean>;
	 ...
	 */
	columnQueryAsync(sql: string, params: QueryParams, options?: {inBackup: boolean, noCache: boolean, debug: boolean, debugParams: boolean}): Promise<Object[][]>;

	logQuery(sql: string, params?: QueryParams, options?: {debug: boolean, debugParams: boolean}): void;
