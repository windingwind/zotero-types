...
declare namespace Zotero {
    interface ProgressWindow {
         ...
         */
        addLines(labels: string | { [key: string | number | symbol]: string }, icons: string | { [key: string | number | symbol]: string }): void;
    ...
    type ItemProgress = {
         ...
         */
        new(iconSrc: string, text: string, parentItemProgress?: ItemProgress): ItemProgress;
