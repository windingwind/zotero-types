...
declare namespace _ZoteroTypes {
    interface Utilities {
         ...
         */
        cleanAuthor(author: string, type: string, useComma?: boolean): { firstName: string, lastName: string, creatorType: string };
         ...
         */
        ellipsize(str: string, len: number, wordBoundary?: boolean, countChars?: boolean): string;
         ...
         * *     returns 1: 1234.57
         */
        numberFormat(number: number, decimals: number, dec_point?: string, thousands_sep?: string): string;
         ...
         */
        walkNoteDOM(note: string, visitors: {
