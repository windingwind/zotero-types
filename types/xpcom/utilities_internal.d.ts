...
declare namespace _ZoteroTypes {
    namespace Utilities {
        ...
        interface Internal {
             ...
             */
            md5Async(file: typeof OS.File | nsIFile | string, base64?: boolean): Promise<string>;
             ...
             */
            updateHTMLInXUL(elem: HTMLElement, options?: { updateHTMLInXUL?: unknown, shiftKey?: boolean, callback?: Function }): void;
             ...
             * @return {Object}
             */
            itemToExportFormat(zoteroItem: Zotero.Item, legacy?: boolean, skipChildItems?: boolean): _ZoteroTypes.anyObj;
             ...
             */
            extractExtraFields(extra: string, item?: Zotero.Item, additionalFields?: string[]): {
             ...
             * @return {String}
             */
            combineExtraFields(extra: string, fieldMap: Map<keyof Zotero.Item.ItemField, unknown>): string;
             ...
             */
            getOpenAccessPDFURLs(doi: string, options?: { timeout: number }): Array<{
                url?: string,
                pageURL?: string,
                version: string
            }>;
            ...
            resolveLocale(locale: _ZoteroTypes.AvailableLocales, locales: _ZoteroTypes.AvailableLocales[]): _ZoteroTypes.AvailableLocales;
             ...
             */
            getNextName(name: string, existingNames: string[], trim?: boolean): string;
             ...
             */
            determineAttachmentIcon(attachment: object & { linkMode: string, mimeType: string }): string;
