...
interface _ZoteroDataObjects {
     ...
     */
    getAsync(id: number, options?: { noCache: boolean }): Promise<Zotero.DataObject>
    getAsync(ids: number[], options?: { noCache: boolean }): Promise<Zotero.DataObject[]>
     ...
     */
    getDeleted(libraryID: number, asIDs?: boolean, days?: number, limit?: number): Promise<Array<number | Zotero.DataObject>>;
     ...
     */
    getByLibraryAndKey(libraryID: number, key: string, options?: unknown): Zotero.DataObject | false;
     ...
     */
    getByLibraryAndKeyAsync(libraryID: number, key: string, options?: { noCache: boolean }): Promise<Zotero.DataObject | false>;
     ...
     */
    getLibraryAndKeyFromID(id: number): false | { libraryID: number, key: string };
     ...
     * @returns Array of id of object
     */
    getNewer(libraryID: number, date: Date, ignoreFutureDates?: boolean): Promise<number[]>;
     ...
     *                             as properties
     */
    getObjectVersions(libraryID: number, keys?: string[]): Promise<{ [key: string]: number }>;
     ...
     * @return {Promise}
     */
    loadDataTypes(objects: Zotero.DataObject[], dataTypes?: string[]): Promise<void>;
     ...
     * @param {Integer[]} [ids]
     */
    _loadDataTypeInLibrary(dataType: string, libraryID: number, ids: number[]): Promise<void>;
     ...
     */
    sortByLevel<T extends _ZoteroDataObject>(objects: T[]): T[];
     ...
     */
    sortByParent<T extends _ZoteroDataObject>(objects: T[]): T[];
     ...
     */
    flattenRelations(relations: __ZoteroTypes.ObjectRelations):
        Array<[__ZoteroTypes.RelationsPredicate, __ZoteroTypes.ZoteroObjectURI]>;
     ...
     */
    reload(ids: number, dataTypes: string[], reloadUnchanged?: boolean): Promise<undefined | true>;
     ...
     * @return {Promise}
     */
    erase(ids: number, options?: _ZoteroDataObject.EraseOptions & {
