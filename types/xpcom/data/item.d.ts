...
declare class _ZoteroItem extends _ZoteroDataObject {
  constructor(itemTypeOrID?: _ZoteroItem.ItemType | number);
  _objectType: 'item';
  readonly ContainerObjectsClass: _ZoteroCollection;
  dateAdded: string;
  dateModified: string;
  version: number;
  synced: boolean;
  ...
  readonly itemType: _ZoteroItem.ItemType;
   ...
   */
  getField(field: _ZoteroItem.ItemField | number, unformatted?: boolean, includeBaseMapped?: boolean): string | number | boolean;
   ...
   */
  loadFromRow(row: { [col in _ZoteroItem.PrimaryField]?: unknown }, reload?: boolean): void;
   ...
   */
  setField(field: _ZoteroItem.ItemField | number, value: string | number | boolean, loadIn?: boolean): void;
   ...
   */
  getCreator(pos: number): _ZoteroItem.Creator;

  /**
   * @param  {Integer} pos
   * @return {Object|Boolean} The API JSON creator data at the given position, or FALSE if none
   */
  getCreatorJSON(pos: number): _ZoteroItem.CreatorJSON;
   ...
   */
  setCreator(orderIndex: number, data: _ZoteroItem.CreatorJSON | _ZoteroItem.Creator, options?: { strict: boolean }): boolean;

  /**
   * @param {Object[]} data - An array of creator data in internal or API JSON format
   */
  setCreators(data: Array<_ZoteroItem.CreatorJSON | _ZoteroItem.Creator>, options?: { strict: boolean }): void;
   ...
   */
  getBestAttachment(): Promise<_ZoteroItem | false>;
  ...
  multiDiff(otherItems: Zotero.Item[], ignoreFields?: string[]): false | {
    [field in _ZoteroItem.ItemField]?: Array<string | __ZoteroTypes.anyObj>
  };
  ...
  toJSON(options?: object): { [field in _ZoteroItem.ItemField]: string | unknown };
