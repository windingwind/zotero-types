...
declare namespace _ZoteroDataObject {
...
declare class _ZoteroDataObject {
    ...
    ObjectsClass: typeof this extends _ZoteroItem ? _ZoteroItems :
        (typeof this extends _ZoteroCollection ? _ZoteroCollections :
            (typeof this extends _ZoteroSearch ? _ZoteroSearches : _ZoteroDataObjects));
    itemTypeID: number;
     ...
     */
    getRelations(): __ZoteroTypes.ObjectRelations;
     ...
     */
    getRelationsByPredicate(predicate: __ZoteroTypes.RelationsPredicate): __ZoteroTypes.ZoteroObjectURI[];

    /**
     * @return {Boolean} - True if the relation has been queued, false if it already exists
     */
    addRelation(predicate: __ZoteroTypes.RelationsPredicate, object: __ZoteroTypes.ZoteroObjectURI): boolean;

    hasRelation(predicate: __ZoteroTypes.RelationsPredicate, object: __ZoteroTypes.ZoteroObjectURI): boolean;
    removeRelation(predicate: __ZoteroTypes.RelationsPredicate, object: __ZoteroTypes.ZoteroObjectURI): boolean;
     ...
     */
    setRelations(newRelations: __ZoteroTypes.ObjectRelations): boolean;
     ...
     */
    _addLinkedObject(object: _ZoteroDataObject): Promise<boolean>;
     ...
     */
    save(options?: _ZoteroDataObject.SaveOptions): Promise<boolean | number>;
    saveTx(options?: _ZoteroDataObject.SaveOptions): Promise<boolean | number>;
    ...
    eraseTx(options?: _ZoteroDataObject.EraseOptions): Promise<boolean>;
    /**
     ...
     */
    erase(options?: _ZoteroDataObject.EraseOptions): Promise<boolean>;

    _finalizeErase(env: unknown): Promise<void>;
    toResponseJSON(options?: {}): {
        key: string,
        version: number,
        meta: __ZoteroTypes.anyObj,
        data: __ZoteroTypes.anyObj
    };
