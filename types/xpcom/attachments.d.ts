...
declare namespace _ZoteroTypes {
    ...
    interface Attachments {
         ...
         */
        importFromFile(options: Attachments.OptionsFromFile & {
            libraryID?: number;
            fileBaseName?: string;
        }): Promise<Zotero.Item>;
         ...
         * @return {Promise<Zotero.Item>}
         */
        linkFromFileWithRelativePath(options: Attachments.OptionsFromFile): Promise<Zotero.Item>;
         ...
         */
        downloadFile(url: string, path: string, options?: { cookieSandbox?: object, referrer?: string }): Promise<boolean>;
         ...
         * @param {Object} [options.cookieSandbox]
         */
        downloadPDFViaBrowser(url: string, path: string, options?: { cookieSandbox?: object }): Promise<boolean>;

        InvalidPDFException: Error & { message: 'Downloaded PDF was not a PDF', stack: string };
        ...
        addAvailablePDFs(
            items: Zotero.Item[],
            options?: { methods?: Attachments.AccessMethod, sameDomainRequestDelay?: number }
        ): Promise<void>;
         ...
         */
        addAvailablePDF(item: Zotero.Item, options?: { methods: Attachments.AccessMethod }): Promise<Zotero.Item | false>;
        ...
        downloadFirstAvailableFile(
            urlResolvers: Array<string | Attachments.UrlResolver | (() => Promise<Attachments.UrlResolver>)>,
            path: string,
            options: { onBeforeRequest: Function, onAfterRequest: Function, onRequestError: Function }
        ...
        getRenamedFileBaseNameIfAllowedType(parentItem: Zotero.Item, file: string): Promise<string>;
         ...
         */
        moveAttachmentToLibrary(attachment: Zotero.Item, libraryID: number, parentItemID?: number): Promise<number>;
         ...
         */
        copyAttachmentToLibrary(attachment: Zotero.Item, libraryID: number, parentItemID?: number): Promise<Zotero.Item>;

        convertLinkedFileToStoredFile(item: Zotero.Item, options?: { move: boolean }): Promise<Zotero.Item>;
