...
declare namespace _ZoteroTypes {
    namespace Reader {
        ...
        type PromiseCapability = typeof import('pdfjs-dist/types/src/shared/util').PromiseCapability;
        type PDFPageProxy = typeof import('pdfjs-dist/types/src/display/api').PDFPageProxy;
        type PDFDocumentProxy = typeof import('pdfjs-dist/types/src/display/api').PDFDocumentProxy;
        type PDFDocumentLoadingTask = typeof import('pdfjs-dist/types/src/display/api').PDFDocumentLoadingTask;
        type PDFViewer = typeof import('pdfjs-dist/types/web/pdf_viewer').PDFViewer;
        type PDFThumbnailViewer = typeof import('pdfjs-dist/types/web/pdf_thumbnail_viewer').PDFThumbnailViewer;
        type PDFLinkService = typeof import('pdfjs-dist/types/web/pdf_link_service').PDFLinkService;
        type PDFHistory = typeof import('pdfjs-dist/types/web/pdf_history').PDFHistory;
        type PDFFindController = typeof import('pdfjs-dist/types/web/pdf_find_controller').PDFFindController;
        type PDFRenderingQueue = typeof import('pdfjs-dist/types/web/pdf_rendering_queue').PDFRenderingQueue;
        type PDFScriptingManager = typeof import('pdfjs-dist/types/web/pdf_scripting_manager').PDFScriptingManager;
        ...
        interface PDFViewerApplication extends anyObj {
            ...
            _initializePdfHistory({ fingerprint, viewOnLoad, initialDest }: anyObj): void;
            _initializeAnnotationStorageCallbacks(pdfDocument: PDFDocumentProxy): void;
            _cleanup(): void;
            forceRendering(): void;
            beforePrint(): void;
            afterPrint(): void;
