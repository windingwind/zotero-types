...
/// <reference types="epubjs" />
/// <reference types="epubjs/types/book" />
...
declare namespace _ZoteroTypes {
    namespace Reader {
        ...
        class EPUBView extends DOMView<EPUBViewState, EPUBViewData> {
            ...
            getData(): { book: Book };
            protected _onInitialDisplay(viewState: Partial<Readonly<EPUBViewState>>): Promise<void>;
            private _initPageMapping(viewState: Partial<Readonly<EPUBViewState>>): Promise<void>;
