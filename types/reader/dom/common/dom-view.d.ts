...
declare namespace _ZoteroTypes {
    namespace Reader {
        ...
        interface CustomScrollIntoViewOptions extends Omit<ScrollIntoViewOptions, 'inline'> {
            block?: 'center' | 'start';
            ifNeeded?: boolean;
            offsetY?: number;
        }
        ...
        abstract class DOMView<State extends DOMViewState, Data> {
            ...
            protected _openExternalLinkOverlayPopup(linkNode: HTMLAnchorElement): void;
            ...
            private _handleAnnotationPointerDown(id: string, event: React.PointerEvent): void;
            private _handleAnnotationPointerUp(id: string, event: React.PointerEvent): void;
            private _getAnnotationsAtPoint(clientX: number, clientY: number): string[];
            private _handleAnnotationDragStart(id: string, dataTransfer: DataTransfer): void;
            private _handleAnnotationResizeStart(_id: string): void;
            private _handleAnnotationResizeEnd(id: string, range: Range, cancelled: boolean): void;
